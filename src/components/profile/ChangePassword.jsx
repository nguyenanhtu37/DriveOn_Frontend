    ...
    <div className="space-y-4 p-6 border border-gray rounded-lg bg-gray-50">
      ...
      <div className="flex space-x-4 pt-2">
        <button
          ...
          disabled={loading}
          className="flex-1 px-6 py-3 bg-primary text-white rounded-lg hover:bg-primary/90 transition-all duration-200 shadow-md"
        >
        ...
        <button
          type="button"
          onClick={onCancel}
          className="flex-1 px-6 py-3 bg-gray-500 text-white rounded-lg hover:bg-gray-600 transition-all duration-200 shadow-md"
        >
          Cancel
        </button>
      </div>
