...
const Feedback = () => {
  const isOpen = useDialogOpen("FeedbackAppointment");
  const appointmentId = useDialogData("FeedbackAppointment");
  ...
  }, [appointment.isSuccess, appointmentData]);
