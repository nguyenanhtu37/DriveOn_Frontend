...
const ServiceDetail = () => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={handleClose}>
      <DialogContent
        hiddenClose={true}
        className="p-0 focus:outline-none max-w-[1200px] min-h-[70vh] max-h-[90vh] overflow-hidden"
      >
        <div className="grid grid-cols-1 lg:grid-cols-2 h-[90vh]">
          {/* Service Information Side */}
          <ScrollArea className="p-6 border-r h-full overflow-auto">
          ...
          {/* Feedback Side */}
          <ScrollArea className="p-6 h-full overflow-auto">
